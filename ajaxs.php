...
die(json_encode(array('status' => 99, 'messages' => '<input id="link-dd" class="swal2-input" value="'.$tenmien.'/xem.php?id='.$id_post.'" readonly><br><a class="btn btn-sm btn-warning" onclick="copy()">Copy Link</a><br>Hãy nhấp vào nút "copy link" ở trên và gửi cho người bạn thương ngay nhé 💖💖💖<br><br>Nếu không biết dùng có thể xem hướng dẫn.<br><a href="/">Hướng dẫn sử dụng</a>')));
}else{
